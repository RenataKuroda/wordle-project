...
////// To add letter inside the squares and wordInput///////
...
///////To delete letters and remove it from wordInput///////
...
///////Change square and keyboard colors when comparing with the wordle///////
    ...
    for(let i = 0; i < rowSquares.length; i++){
        ...
        setTimeout(() => {
            ...
            if (letter === wordle[i]){
                ...
                changeKeyboardColor(letter, 'green-overlay')
...
function changeKeyboardColor(keyLetter, color){
    const key = document.getElementById(keyLetter)
    key.classList.add(color)
}

///////Code to show winning or losing messages///////
...
///////Message to accept only words in words array///////
